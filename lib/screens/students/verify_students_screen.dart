 ...
 // bool _showBottomNav = true;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: const CustomAppBar(title: 'Verify Students'),
      body: Consumer<StudentProvider>(
        builder: (context, provider, child) {
          if (provider.isLoading && provider.pendingStudents.isEmpty) {
                  ...
                  child: Column(
                    children: [
                      ...
                      ConstrainedBox(
                        ...
                        child: provider.pendingStudents.isEmpty
                            ? Center(
                          child: Padding(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return StudentCard(
                              ...
                              onPressedSendReq: (){
                                ...
                                provider.updateStudent(student.copyWith(status: 'approved'));
                                setState(() {

                                });
                                //todo: open marks popup -> fetch subjects of that course -> add all marks -> send real req -> update status to sent
                              },
                              sendReqButtonText: student.status == 'sent' ? 'Verify' : "", //status: 'notsent', 'sent', 'approved',
                              cardColor: cardColor,
                              student: student,
                              onTap: () {
